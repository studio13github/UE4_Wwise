...
public:
	...
	static TSharedRef<FAssetDragDropOp> New(TArray<WwisePickerHelpers::WwisePickerAssetPayload> InAssetData, UActorFactory* ActorFactory = nullptr);

	static TSharedRef<FAssetDragDropOp> New(TArray<WwisePickerHelpers::WwisePickerAssetPayload> InAssetData, TArray<FString> InAssetPaths, UActorFactory* ActorFactory);
...
private:
	...
	TArray<WwisePickerHelpers::WwisePickerAssetPayload> WwiseAssetsToDrop;
